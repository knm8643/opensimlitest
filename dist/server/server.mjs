import { reactive, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, isRef, h, isReadonly, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-6ecb7e92.js").then((r) => r.default || r));
